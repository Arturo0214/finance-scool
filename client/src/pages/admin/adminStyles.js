...
export const getAdminCSS = () => `
  ...
  *, *::before, *::after { box-sizing:border-box; }
  ...
  .sb-head { display:flex; align-items:center; justify-content:space-between; padding:0 16px; margin-bottom:14px; flex-shrink:0; }
  ...
  /* min-height:0 es obligatorio: sin él el flex-item no puede encogerse y el
     ...
     El mask-image desvanece los bordes al scrollear para que los items no se
     vean "encimados" contra el logo o el botón de salir. */
  .sb-nav { flex:1; min-height:0; display:flex; flex-direction:column; gap:2px; padding:2px 12px 8px; overflow-y:auto; scrollbar-width:thin; scrollbar-color:rgba(255,255,255,.22) transparent;
  ...
  .sb-item {
    background:none; border:none; color:rgba(255,255,255,.66); padding:8.5px 13px; border-radius:10px;
    cursor:pointer; display:flex; align-items:center; gap:11px; font-size:13px; font-weight:500;
    letter-spacing:.1px; transition:all .18s ease; white-space:nowrap; font-family:inherit; position:relative; flex-shrink:0;
  }
  ...
  .sb-divider { padding:12px 13px 5px; font-size:9.5px; text-transform:uppercase; letter-spacing:2.2px; color:rgba(232,207,166,.5); font-weight:600; pointer-events:none; flex-shrink:0; }
  .sb-logout { background:none; border:none; color:rgba(255,255,255,.55); padding:10px 13px; border-radius:0 0 10px 10px; cursor:pointer; display:flex; align-items:center; gap:11px; font-size:13px; margin:0 12px; transition:all .2s; font-family:inherit; white-space:nowrap; border-top:1px solid rgba(255,255,255,.1); flex-shrink:0; }
